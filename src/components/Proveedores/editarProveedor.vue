      ...
      <div class="card-body">
        <form @submit.prevent="enviar_form()">
          ...
          <div class="form-row">
            <div class="col">
              <div class="form-group">
                <label for="raz">Razon social:</label>
                <input
                  v-model="razonSocial"
                  type="text"
                  class="form-control"
            ...
            <div class="card-body">
              <div class="col-auto my-1">
                <div class="custom-control custom-checkbox mr-sm-2">
                  <input
                    v-model="cambiarDireccion"
                    type="checkbox"
                    class="custom-control-input"
                    id="check"
                  />
                  <label class="custom-control-label" for="check">
                    <small class="text-danger">Cambiar departamento y municipio</small></label>
                </div>
              </div>
              ...
              <div class="form-row" v-if="cambiarDireccion">
                ...
                <div class="col">
                  <div class="form-group">
                    ...
                    <option
                      v-for="(item, index) in municipiosArray"
                      :key="index"
                    >
                      {{ item }}
                    </option>
