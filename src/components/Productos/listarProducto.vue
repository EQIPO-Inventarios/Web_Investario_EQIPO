...
import agregar from '@/components/Productos/agregarProducto.vue'
import editar from '@/components/Productos/editarProducto.vue'
      ...
      eliminar(id, nombre) {
          Swal.fire({
                  ...
                  confirmButtonText: 'Eliminar'
                    ...
                    if (result.value) {
                        axios.delete(`/Productos/eliminar/${id}`)
                        .then(response => {
